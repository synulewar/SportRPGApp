...
@Database(entities = arrayOf(User::class, Credentials::class, Training::class, Item::class, Skill::class, BasicSkill::class), version = 1)
abstract class SportRPGDatabase : RoomDatabase() {
    ...
    abstract fun basicSkillDao(): BasicSkillDao
